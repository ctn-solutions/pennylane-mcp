...
function tool(name: string, description: string, schema: any, handler: (args: any) => Promise<unknown>) {
  server.tool(name, description, schema.shape || schema, async (args: any) => {
    try {
...
// Bank Accounts
tool("pennylane_list_bank_accounts", "List all bank accounts", paginationSchema,
  (a: any) => client.listBankAccounts({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_bank_account", "Retrieve a bank account by ID", z.object({ id: z.number() }),
  (a: any) => client.getBankAccount(a.id));
...
}), (a: any) => client.createBankAccount(a));

// Bank Establishments
tool("pennylane_list_bank_establishments", "List bank establishments", paginationSchema,
  (a: any) => client.listBankEstablishments({ cursor: a.cursor, limit: a.limit }));

// Billing Subscriptions
tool("pennylane_list_billing_subscriptions", "List billing subscriptions", filterSortSchema,
  (a: any) => client.listBillingSubscriptions({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_billing_subscription", "Get a billing subscription by ID", z.object({ id: z.number() }),
  (a: any) => client.getBillingSubscription(a.id));
tool("pennylane_create_billing_subscription", "Create a billing subscription", z.object({
  name: z.string(), customer_id: z.number(),
}), (a: any) => client.createBillingSubscription(a));
...
}), (a: any) => client.updateBillingSubscription(a.id, a));
...
}), (a: any) => client.listBillingSubscriptionInvoiceLineSections(a.billing_subscription_id, { cursor: a.cursor, limit: a.limit }));
tool("pennylane_list_billing_subscription_invoice_lines", "List invoice lines for a billing subscription", z.object({
  billing_subscription_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(),
}), (a: any) => client.listBillingSubscriptionInvoiceLines(a.billing_subscription_id, { cursor: a.cursor, limit: a.limit }));

// Categories
tool("pennylane_list_categories", "List all categories", filterSortSchema,
  (a: any) => client.listCategories({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_category", "Get a category by ID", z.object({ id: z.number() }),
  (a: any) => client.getCategory(a.id));
...
}), (a: any) => client.updateCategory(a.id, a));

// Category Groups
tool("pennylane_list_category_groups", "List all category groups", paginationSchema,
  (a: any) => client.listCategoryGroups({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_category_group", "Get a category group by ID", z.object({ id: z.number() }),
  (a: any) => client.getCategoryGroup(a.id));
...
}), (a: any) => client.listCategoryGroupCategories(a.category_group_id, { cursor: a.cursor, limit: a.limit }));

// Customers
tool("pennylane_list_customers", "List all customers (company and individual)", filterSortSchema,
  (a: any) => client.listCustomers({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_customer", "Get a customer by ID", z.object({ id: z.number() }),
  (a: any) => client.getCustomer(a.id));
...
}), (a: any) => client.listCustomerCategories(a.customer_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.updateCustomerCategories(a.customer_id, a.categories));
tool("pennylane_list_customer_contacts", "List contacts of a customer", z.object({
  customer_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(),
}), (a: any) => client.listCustomerContacts(a.customer_id, { cursor: a.cursor, limit: a.limit }));

// Company Customers
tool("pennylane_get_company_customer", "Get a company customer by ID", z.object({ id: z.number() }),
  (a: any) => client.getCompanyCustomer(a.id));
...
}), (a: any) => client.createCompanyCustomer(a));
tool("pennylane_update_company_customer", "Update a company customer", z.object({
  ...
  postal_address: z.any().optional(),
}), (a: any) => client.updateCompanyCustomer(a.id, a));

// Individual Customers
tool("pennylane_get_individual_customer", "Get an individual customer by ID", z.object({ id: z.number() }),
  (a: any) => client.getIndividualCustomer(a.id));
...
}), (a: any) => client.createIndividualCustomer(a));
...
}), (a: any) => client.updateIndividualCustomer(a.id, a));

// Suppliers
tool("pennylane_list_suppliers", "List all suppliers", filterSortSchema,
  (a: any) => client.listSuppliers({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_supplier", "Get a supplier by ID", z.object({ id: z.number() }),
  (a: any) => client.getSupplier(a.id));
...
tool("pennylane_update_supplier", "Update a supplier", z.object({
  ...
  supplier_due_date_delay: z.number().optional(), supplier_due_date_rule: z.string().optional(),
  external_reference: z.string().optional(),
}), (a: any) => client.updateSupplier(a.id, a));
...
}), (a: any) => client.listSupplierCategories(a.supplier_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.updateSupplierCategories(a.supplier_id, a.categories));

// Journals
tool("pennylane_list_journals", "List all journals", filterSortSchema,
  (a: any) => client.listJournals({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_journal", "Get a journal by ID", z.object({ id: z.number() }),
  (a: any) => client.getJournal(a.id));
tool("pennylane_create_journal", "Create a journal", z.object({
  name: z.string(), code: z.string(), type: z.string(),
}), (a: any) => client.createJournal(a));

// Ledger Accounts
tool("pennylane_list_ledger_accounts", "List all ledger accounts", filterSortSchema,
  (a: any) => client.listLedgerAccounts({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_ledger_account", "Get a ledger account by ID", z.object({ id: z.number() }),
  (a: any) => client.getLedgerAccount(a.id));
...
}), (a: any) => client.createLedgerAccount(a));
...
}), (a: any) => client.updateLedgerAccount(a.id, a));

// Ledger Entries
tool("pennylane_list_ledger_entries", "List all ledger entries", filterSortSchema,
  (a: any) => client.listLedgerEntries({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_ledger_entry", "Get a ledger entry by ID", z.object({ id: z.number() }),
  (a: any) => client.getLedgerEntry(a.id));
...
}), (a: any) => client.createLedgerEntry(a));
...
}), (a: any) => client.listLedgerEntryLines(a.ledger_entry_id, { cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_ledger_entry_line", "Get a ledger entry line by ID", z.object({ id: z.number() }),
  (a: any) => client.getLedgerEntryLine(a.id));
...
}), (a: any) => client.createLedgerEntryLine(a));
...
}), (a: any) => client.getLedgerEntryLineLettering(a.ledger_entry_line_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.letterLedgerEntryLines(a));
tool("pennylane_list_ledger_entry_line_categories", "List categories of a ledger entry line", z.object({
  ledger_entry_line_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(),
}), (a: any) => client.getLedgerEntryLineCategories(a.ledger_entry_line_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.updateLedgerEntryLineCategories(a.ledger_entry_line_id, a.categories));
...
}), (a: any) => client.uploadLedgerAttachment(a));

// Customer Invoices
tool("pennylane_list_customer_invoices", "List all customer invoices", filterSortSchema,
  (a: any) => client.listCustomerInvoices({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_customer_invoice", "Get a customer invoice by ID", z.object({ id: z.number() }),
  (a: any) => client.getCustomerInvoice(a.id));
...
}), (a: any) => client.createCustomerInvoice(a));
...
}), (a: any) => client.updateCustomerInvoice(a.id, a));
tool("pennylane_delete_customer_invoice", "Delete a draft customer invoice", z.object({ id: z.number() }),
  async (a: any) => { await client.deleteCustomerInvoice(a.id); return { success: true }; });
tool("pennylane_finalize_customer_invoice", "Finalize a draft customer invoice", z.object({ id: z.number() }),
  (a: any) => client.finalizeCustomerInvoice(a.id));
tool("pennylane_mark_customer_invoice_paid", "Mark a customer invoice as paid", z.object({ id: z.number() }),
  (a: any) => client.markAsPaid(a.id));
...
}), (a: any) => client.sendByEmail(a.id, { recipients: a.recipients }));
tool("pennylane_send_customer_invoice_to_pa", "Send a customer e-invoice to PA", z.object({ id: z.number() }),
  (a: any) => client.sendToPa(a.id));
...
}), (a: any) => client.importCustomerInvoice(a));
...
}), (a: any) => client.updateImported(a.id, { status: a.status }));
...
}), (a: any) => client.listCustomerInvoiceLines(a.customer_invoice_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
tool("pennylane_list_customer_invoice_line_sections", "List invoice line sections for a customer invoice", z.object({
  customer_invoice_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(), sort: z.string().optional(),
}), (a: any) => client.listCustomerInvoiceLineSections(a.customer_invoice_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
...
}), (a: any) => client.listCustomerInvoiceAppendices(a.customer_invoice_id, { cursor: a.cursor, limit: a.limit }));
...
tool("pennylane_list_customer_invoice_categories", "List categories of a customer invoice", z.object({
  customer_invoice_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(),
}), (a: any) => client.listCustomerInvoiceCategories(a.customer_invoice_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.updateCustomerInvoiceCategories(a.customer_invoice_id, a.categories));
tool("pennylane_list_customer_invoice_matched_transactions", "List matched transactions for a customer invoice", z.object({
  customer_invoice_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(), sort: z.string().optional(),
}), (a: any) => client.listCustomerInvoiceMatchedTransactions(a.customer_invoice_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
...
}), (a: any) => client.matchCustomerInvoiceTransaction(a.customer_invoice_id, { transaction_id: a.transaction_id }));
tool("pennylane_unmatch_customer_invoice_transaction", "Unmatch a transaction from a customer invoice", z.object({
  customer_invoice_id: z.number(), transaction_id: z.number(),
}), async (a: any) => { await client.unmatchCustomerInvoiceTransaction(a.customer_invoice_id, a.transaction_id); return { success: true }; });
tool("pennylane_list_customer_invoice_payments", "List payments for a customer invoice", z.object({
  customer_invoice_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(), sort: z.string().optional(),
}), (a: any) => client.listCustomerInvoicePayments(a.customer_invoice_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
tool("pennylane_list_customer_invoice_custom_header_fields", "List custom header fields for a customer invoice", z.object({
  customer_invoice_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(),
}), (a: any) => client.listCustomerInvoiceCustomHeaderFields(a.customer_invoice_id, { cursor: a.cursor, limit: a.limit }));

// Supplier Invoices
tool("pennylane_list_supplier_invoices", "List all supplier invoices", filterSortSchema,
  (a: any) => client.listSupplierInvoices({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_supplier_invoice", "Get a supplier invoice by ID", z.object({ id: z.number() }),
  (a: any) => client.getSupplierInvoice(a.id));
tool("pennylane_update_supplier_invoice", "Update a supplier invoice", z.object({
  ...
  invoice_lines: z.any().optional(), external_reference: z.string().optional(),
}), (a: any) => client.updateSupplierInvoice(a.id, a));
...
}), (a: any) => client.listSupplierInvoiceLines(a.supplier_invoice_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
...
}), (a: any) => client.listSupplierInvoiceCategories(a.supplier_invoice_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.updateSupplierInvoiceCategories(a.supplier_invoice_id, a.categories));
tool("pennylane_list_supplier_invoice_payments", "List payments for a supplier invoice", z.object({
  supplier_invoice_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(), sort: z.string().optional(),
}), (a: any) => client.listSupplierInvoicePayments(a.supplier_invoice_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
...
}), (a: any) => client.updateSupplierInvoicePaymentStatus(a.supplier_invoice_id, { payment_status: a.payment_status }));
tool("pennylane_list_supplier_invoice_matched_transactions", "List matched transactions for a supplier invoice", z.object({
  supplier_invoice_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(), sort: z.string().optional(),
}), (a: any) => client.listSupplierInvoiceMatchedTransactions(a.supplier_invoice_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
...
}), (a: any) => client.matchSupplierInvoiceTransaction(a.supplier_invoice_id, { transaction_id: a.transaction_id }));
tool("pennylane_unmatch_supplier_invoice_transaction", "Unmatch a transaction from a supplier invoice", z.object({
  supplier_invoice_id: z.number(), transaction_id: z.number(),
}), async (a: any) => { await client.unmatchSupplierInvoiceTransaction(a.supplier_invoice_id, a.transaction_id); return { success: true }; });
...
}), (a: any) => client.linkSupplierInvoicePurchaseRequest(a.supplier_invoice_id, { purchase_request_id: a.purchase_request_id }));
...
}), (a: any) => client.updateSupplierInvoiceEInvoiceStatus(a.supplier_invoice_id, { status: a.status, reason: a.reason }));
tool("pennylane_validate_supplier_invoice_accounting", "Validate the accounting of a supplier invoice", z.object({ id: z.number() }),
  (a: any) => client.validateSupplierInvoiceAccounting(a.id));
...
}), (a: any) => client.importSupplierInvoice(a));
...
// Quotes
tool("pennylane_list_quotes", "List all quotes", filterSortSchema,
  (a: any) => client.listQuotes({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_quote", "Get a quote by ID", z.object({ id: z.number() }),
  (a: any) => client.getQuote(a.id));
tool("pennylane_send_quote_by_email", "Send a quote by email", z.object({
  id: z.number(), recipients: z.array(z.string()).optional(),
}), (a: any) => client.sendQuoteByEmail(a.id, { recipients: a.recipients }));
...
}), (a: any) => client.updateQuoteStatus(a.id, { status: a.status }));
...
}), (a: any) => client.listQuoteAppendices(a.quote_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.listQuoteInvoiceLines(a.quote_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
tool("pennylane_list_quote_invoice_line_sections", "List invoice line sections for a quote", z.object({
  quote_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(), sort: z.string().optional(),
}), (a: any) => client.listQuoteInvoiceLineSections(a.quote_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));

// Commercial Documents
tool("pennylane_list_commercial_documents", "List all commercial documents", filterSortSchema,
  (a: any) => client.listCommercialDocuments({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_commercial_document", "Get a commercial document by ID", z.object({ id: z.number() }),
  (a: any) => client.getCommercialDocument(a.id));
...
}), (a: any) => client.listCommercialDocumentAppendices(a.commercial_document_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.listCommercialDocumentInvoiceLines(a.commercial_document_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));
tool("pennylane_list_commercial_document_invoice_line_sections", "List invoice line sections for a commercial document", z.object({
  commercial_document_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(), sort: z.string().optional(),
}), (a: any) => client.listCommercialDocumentInvoiceLineSections(a.commercial_document_id, { cursor: a.cursor, limit: a.limit, sort: a.sort }));

// Transactions
tool("pennylane_list_transactions", "List all transactions", filterSortSchema,
  (a: any) => client.listTransactions({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_transaction", "Get a transaction by ID", z.object({ id: z.number() }),
  (a: any) => client.getTransaction(a.id));
...
}), (a: any) => client.createTransaction(a));
...
}), (a: any) => client.updateTransaction(a.id, a));
...
}), (a: any) => client.listTransactionCategories(a.transaction_id, { cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.updateTransactionCategories(a.transaction_id, a.categories));
tool("pennylane_list_transaction_matched_invoices", "List invoices matched to a bank transaction", z.object({
  transaction_id: z.number(), cursor: z.string().optional(), limit: z.number().optional(),
}), (a: any) => client.listTransactionMatchedInvoices(a.transaction_id, { cursor: a.cursor, limit: a.limit }));

// Products
tool("pennylane_list_products", "List all products", filterSortSchema,
  (a: any) => client.listProducts({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_product", "Get a product by ID", z.object({ id: z.number() }),
  (a: any) => client.getProduct(a.id));
...
}), (a: any) => client.updateProduct(a.id, a));

// Fiscal Years
tool("pennylane_list_fiscal_years", "List all fiscal years", paginationSchema,
  (a: any) => client.listFiscalYears({ cursor: a.cursor, limit: a.limit }));
...
}), (a: any) => client.getTrialBalance(a));

// Webhook Subscriptions
tool("pennylane_list_webhook_subscriptions", "List all webhook subscriptions", paginationSchema,
  (a: any) => client.listWebhookSubscriptions({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_webhook_subscription", "Get a webhook subscription by ID", z.object({ id: z.number() }),
  (a: any) => client.getWebhookSubscription(a.id));
...
}), (a: any) => client.createWebhookSubscription(a));
...
}), (a: any) => client.updateWebhookSubscription(a.id, a));
tool("pennylane_delete_webhook_subscription", "Delete a webhook subscription", z.object({ id: z.number() }),
  async (a: any) => { await client.deleteWebhookSubscription(a.id); return { success: true }; });

// SEPA Mandates
tool("pennylane_list_sepa_mandates", "List all SEPA mandates", filterSortSchema,
  (a: any) => client.listSepaMandates({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_sepa_mandate", "Get a SEPA mandate by ID", z.object({ id: z.number() }),
  (a: any) => client.getSepaMandate(a.id));
...
}), (a: any) => client.createSepaMandate(a));
tool("pennylane_update_sepa_mandate", "Update a SEPA mandate", z.object({
  ...
  sequence_type: z.enum(["FRST", "OOFF", "RCUR", "FNAL"]).optional(),
}), (a: any) => client.updateSepaMandate(a.id, a));
tool("pennylane_delete_sepa_mandate", "Delete a SEPA mandate", z.object({ id: z.number() }),
  async (a: any) => { await client.deleteSepaMandate(a.id); return { success: true }; });

// GoCardless Mandates
tool("pennylane_list_gocardless_mandates", "List all GoCardless mandates", paginationSchema,
  (a: any) => client.listGocardlessMandates({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_gocardless_mandate", "Get a GoCardless mandate by ID", z.object({ id: z.number() }),
  (a: any) => client.getGocardlessMandate(a.id));
...
}), (a: any) => client.associateGocardlessMandate(a.mandate_id, { customer_id: a.customer_id }));
tool("pennylane_cancel_gocardless_mandate", "Cancel a GoCardless mandate", z.object({
  mandate_id: z.number(), reason: z.string(),
}), (a: any) => client.cancelGocardlessMandate(a.mandate_id, { reason: a.reason }));
...
}), (a: any) => client.sendGocardlessMailRequest({ gocardless_mandate_ids: a.gocardless_mandate_ids }));
...
}), (a: any) => client.createGeneralLedgerExport(a));
tool("pennylane_get_export", "Get an export by ID", z.object({ id: z.number() }),
  (a: any) => client.getExport(a.id));
...
}), (a: any) => client.createFecExport(a));
tool("pennylane_create_analytical_ledger_export", "Create an Analytical General Ledger export", z.object({
  fiscal_year_id: z.number(), period_start: z.string().optional(), period_end: z.string().optional(),
}), (a: any) => client.createAnalyticalLedgerExport(a));

// Changelogs
tool("pennylane_get_customer_invoice_changelogs", "Get customer invoice change events", paginationSchema,
  (a: any) => client.getCustomerInvoiceChangelogs({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_supplier_invoice_changelogs", "Get supplier invoice change events", paginationSchema,
  (a: any) => client.getSupplierInvoiceChangelogs({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_customer_changelogs", "Get customer change events", paginationSchema,
  (a: any) => client.getCustomerChangelogs({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_supplier_changelogs", "Get supplier change events", paginationSchema,
  (a: any) => client.getSupplierChangelogs({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_product_changelogs", "Get product change events", paginationSchema,
  (a: any) => client.getProductChangelogs({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_ledger_entry_line_changelogs", "Get ledger entry line change events", paginationSchema,
  (a: any) => client.getLedgerEntryLineChangelogs({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_transaction_changelogs", "Get transaction change events", paginationSchema,
  (a: any) => client.getTransactionChangelogs({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_get_quote_changelogs", "Get quote change events", paginationSchema,
  (a: any) => client.getQuoteChangelogs({ cursor: a.cursor, limit: a.limit }));

// Purchase Requests
tool("pennylane_list_purchase_requests", "List all purchase requests", filterSortSchema,
  (a: any) => client.listPurchaseRequests({ cursor: a.cursor, limit: a.limit, filter: a.filter, sort: a.sort }));
tool("pennylane_get_purchase_request", "Get a purchase request by ID", z.object({ id: z.number() }),
  (a: any) => client.getPurchaseRequest(a.id));
...
// Pro Account
tool("pennylane_list_pro_account_mandate_requests", "List pro account mandate requests", paginationSchema,
  (a: any) => client.listProAccountMandateRequests({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_list_pro_account_mandate_migrations", "List pro account mandate migrations", paginationSchema,
  (a: any) => client.listProAccountMandateMigrations({ cursor: a.cursor, limit: a.limit }));
tool("pennylane_list_pro_account_mandates", "List pro account mandates", paginationSchema,
  (a: any) => client.listProAccountMandates({ cursor: a.cursor, limit: a.limit }));

// Me
tool("pennylane_get_me", "Get the authenticated user info", z.object({}),
  () => client.getMe());

// Customer Invoice Templates
tool("pennylane_list_customer_invoice_templates", "List customer invoice templates", paginationSchema,
  (a: any) => client.listCustomerInvoiceTemplates({ cursor: a.cursor, limit: a.limit }));
